...
export class SignUpComponent {
  ...
  constructor(
    ...
    this.signupform = new FormGroup({
      first__name: new FormControl('', [
        Validators.required,
        Validators.pattern(GlobalConstants.nameRegex),
      ]),
      last__name: new FormControl('', [
        Validators.required,
        Validators.pattern(GlobalConstants.nameRegex),
      ]),
      ...
      rePassword: new FormControl('', [
        Validators.required,
        Validators.minLength(8),
        GlobalConstants.passwordMatchValidator,
      ]),
      CV: new FormControl([], [Validators.required]),
      birthday: new FormControl('', [
        Validators.required,
        GlobalConstants.minimumAgeValidator(18),
      ]),
    });
  }
  radioo() {
      ...
      this.userService.signup(dataUser).subscribe(
        (response: any) => {
          ...
          this.messageService.add({
            severity: 'success',
            summary: 'Success',
            detail: 'Welcomme, request sended successfully',
          });
