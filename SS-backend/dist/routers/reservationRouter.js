...
routerReservation.get('/reservationTeacher', reservationController_1.getReservationTeacher);
routerReservation.get('/specificreservation/:groupid', reservationController_1.getSpecificReservations);
...
routerReservation.post('/sendcode', reservationController_1.sendCodeExam);
